...
x1_array= -2:0.1:2;
    A1 = gaussmf(x1_array, [0.8 -1]);
    A2 = gaussmf(x1_array, [0.8 1]);
    figure(2)
...
for n= 1:length(x1)
    ...
    w1=gaussmf(x1(n), [0.8 -1])*gaussmf(x2(n), [0.8 -1])*gaussmf(x3(n), [0.8 -1]);%A1 B1 C1
    w2=gaussmf(x1(n), [0.8 -1])*gaussmf(x2(n), [0.8 -1])*gaussmf(x3(n), [0.8 1]); %A1 B1 C2
    w3=gaussmf(x1(n), [0.8 -1])*gaussmf(x2(n), [0.8 1])*gaussmf(x3(n), [0.8 -1]); %A1 B2 C1
    w4=gaussmf(x1(n), [0.8 -1])*gaussmf(x2(n), [0.8 1])*gaussmf(x3(n), [0.8 1]); %A1 B2 C2
    w5=gaussmf(x1(n), [0.8 1])*gaussmf(x2(n), [0.8 -1])*gaussmf(x3(n), [0.8 -1]); %A2 B1 C1
    w6=gaussmf(x1(n), [0.8 1])*gaussmf(x2(n), [0.8 -1])*gaussmf(x3(n), [0.8 1]); %A2 B1 C2
    w7=gaussmf(x1(n), [0.8 1])*gaussmf(x2(n), [0.8 1])*gaussmf(x3(n), [0.8 -1]);%A2 B2 C1
    w8=gaussmf(x1(n), [0.8 1])*gaussmf(x2(n), [0.8 1])*gaussmf(x3(n), [0.8 1]); %A2 B2 C2
...
%% PERFORMANCE FOR TRAINING DATA with founded rule parameter 
    ...
    for i= 1:length(x1)
        ...
        w1=gaussmf(x1(i), [0.8 -1])*gaussmf(x2(i), [0.8 -1])*gaussmf(x3(i), [0.8 -1]);%A1 B1 C1
        w2=gaussmf(x1(i), [0.8 -1])*gaussmf(x2(i), [0.8 -1])*gaussmf(x3(i), [0.8 1]); %A1 B1 C2
        w3=gaussmf(x1(i), [0.8 -1])*gaussmf(x2(i), [0.8 1])*gaussmf(x3(i), [0.8 -1]); %A1 B2 C1
        w4=gaussmf(x1(i), [0.8 -1])*gaussmf(x2(i), [0.8 1])*gaussmf(x3(i), [0.8 1]); %A1 B2 C2
        w5=gaussmf(x1(i), [0.8 1])*gaussmf(x2(i), [0.8 -1])*gaussmf(x3(i), [0.8 -1]); %A2 B1 C1
        w6=gaussmf(x1(i), [0.8 1])*gaussmf(x2(i), [0.8 -1])*gaussmf(x3(i), [0.8 1]); %A2 B1 C2
        w7=gaussmf(x1(i), [0.8 1])*gaussmf(x2(i), [0.8 1])*gaussmf(x3(i), [0.8 -1]);%A2 B2 C1
        w8=gaussmf(x1(i), [0.8 1])*gaussmf(x2(i), [0.8 1])*gaussmf(x3(i), [0.8 1]); %A2 B2 C2
